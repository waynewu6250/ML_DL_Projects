...
[3. Movie Bot with keras](#3) <br>
[4. Image captioning](#4) <br>
[5. Recurrent Neural Network for Taiwanese song's lyrics generation](#5) <br>
...
This is a nlp project completely done by Ting-Wei Wu with data preprocessing and pytorch seq2seq model establishment. <br>
There are two kinds of robots for you to choose: **MovieBot** and **ChickBot**. <br>
...
This is a deep learning project completely done by Ting-Wei Wu. Basically, it will generate some intriguing lyrics based on the major taiwanese songs' style. The networks are based on simple RNN model with major three singers. <br>

<img src="5.Lyrics-RNN/bg.jpg" height="220" width="330">
...
This is a deep learning project completely done by Ting-Wei Wu. Basically, it simulated the style drawing from Naruto figures to construct new naruto characters by artificial intelligence. <br>
...
<img src="9.Mario-in-RL/mario.jpg"  height="220" width="330">
